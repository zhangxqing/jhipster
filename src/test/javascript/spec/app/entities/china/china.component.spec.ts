...
import { ChinaComponent } from 'app/entities/china/china.component';
import { ChinaService } from 'app/entities/china/china.service';
import { China } from 'app/shared/model/china.model';

describe('Component Tests', () => {
    describe('China Management Component', () => {
        let comp: ChinaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ChinaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.chinas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
